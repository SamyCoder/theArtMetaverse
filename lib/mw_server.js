...
{ 
    ...
    /**
     * This has been established for private messaging
     */
    socket.on('ptivateMessage', function(userName, message) {
        //console.log("I am a user in mw_server", userName);
...
//        userName = privateOption.text;
        
        console.log("I am the private user", userName);
        //userName = "Users Online";
        
        io.emit('chatUpdatePrivate', userName, message);
    });
    
//    socket.on('ptivateMessageUser', function(userName, message){
//
//
//        io.emit('privateMsgUpdate', newUser, message);
//    }
